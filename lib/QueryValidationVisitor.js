...
module.exports = class QueryValidationVisitor {
  ...
  onSelectionSetEnter (node) {
    ...
    if (this.currentTypeInfo.introspection) {
      this.currentTypeInfo = { parent: this.currentTypeInfo, introspection: true }
    ...
    if (this.currentTypeInfo.introspection) {
      // logDebug('onSelectionSetEnter is introspection')
    }
  }
  ...
  onFieldEnter (node) {
    ...
    if (this.currentTypeInfo.introspection) return
